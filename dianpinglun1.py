...
headers_pinglun = {
    ...
    'cookie':'_lxsdk_cuid=16d62ea6ca027-0a4910b28fb0df-67e1b3f-100200-16d62ea6ca1c8; _lxsdk=16d62ea6ca027-0a4910b28fb0df-67e1b3f-100200-16d62ea6ca1c8; _hc.v=c882456c-1f19-3cb7-e5a0-1121d5489bdd.1569322594; dper=59ce2667699ea89fbc4655c1e760911f6051307027e8a99460b3570c646358deb627eb975f642a5ecbc0e1b74b3de0882d44ccedf3dc4fdc7ea8611ccf9a482454c63f6b7f22e15bf3220de0ccf496424c9735957c231c6d1b6c9fa1065c1c04; ua=%E7%99%BD%E5%99%AA%E9%9F%B3; ctu=41c1fd0e93c86ea7559dba081079ee30592d2ef5e0aeb74b35665e82babbf339; cityInfo=%7B%22cityId%22%3A1%2C%22cityName%22%3A%22%E4%B8%8A%E6%B5%B7%22%2C%22provinceId%22%3A0%2C%22parentCityId%22%3A0%2C%22cityOrderId%22%3A0%2C%22isActiveCity%22%3Afalse%2C%22cityEnName%22%3A%22shanghai%22%2C%22cityPyName%22%3Anull%2C%22cityAreaCode%22%3Anull%2C%22cityAbbrCode%22%3Anull%2C%22isOverseasCity%22%3Afalse%2C%22isScenery%22%3Afalse%2C%22TuanGouFlag%22%3A0%2C%22cityLevel%22%3A0%2C%22appHotLevel%22%3A0%2C%22gLat%22%3A0%2C%22gLng%22%3A0%2C%22directURL%22%3Anull%2C%22standardEnName%22%3Anull%7D; cy=1; cye=shanghai; s_ViewType=10; ll=7fd06e815b796be3df069dec7836c3df; _lx_utm=utm_source%3Dwww.sogou%26utm_medium%3Dorganic; _lxsdk_s=16d878fa741-d84-e65-d6c%7C%7C21'
}
...
def get_content(url,headers_pinglun):
    ...
    doc = pq(html.text)
    svg_dict,css_dict = get_dict(doc)
    # print(svg_dict)
    # print(css_dict)
    ...
    for li in pinglunli:
        ...
        pinglun = pinglun_decode(svg_dict,css_dict,pinglun_html)
        print(pinglun)
...
def get_dict(doc):
    ...
    svg_dict = get_svg_dict(svg_link)
    #获得中间列表和svg字典
...
def pinglun_decode(svg_dict,css_dict,pinglun_html):
